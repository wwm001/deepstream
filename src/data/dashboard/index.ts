import type { DashboardSectionsRecord } from "./types";

export * from "./types";
export { homeFocusItems, homeSystemSnapshotItems } from "./homeData";
export { streamEvents } from "./streamData";
export { libraryAssets } from "./libraryData";
export { settingsChecks } from "./settingsData";
...
export const totalDashboardCards = Object.values(dashboardSections).reduce(
  (sum, section) => sum + section.cards.length,
  0
);

export const totalSections = Object.keys(dashboardSections).length;